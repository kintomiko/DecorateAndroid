 ...
 */
package com.example.kin.decorate.notification;
...
public class NotificationService extends Service {
    ...
    public static final String SERVICE_NAME = "com.example.kin.decorate.notification.NotificationService";
    ...
    public static Intent getIntent(Context context) {
        Intent rst =  new Intent(context, NotificationService.class);
        rst.setAction(SERVICE_NAME);
        return rst;
    }
