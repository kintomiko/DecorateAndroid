...
public class ItemListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    for(int i=0;i<response.length();i++){
                        ...
                        Project project = new Project(jsonObject.getJSONObject("fields").getString("desc"), jsonObject.getInt("pk"));
                        projectList.add(project);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                setListAdapter(new ArrayAdapter<Project>(
                        getActivity(),
        ...
        DecorateUtils.notify(getActivity().getApplicationContext());
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(projectList.get(position).id.toString());
    }
